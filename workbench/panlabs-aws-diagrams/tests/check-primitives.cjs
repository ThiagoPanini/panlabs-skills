...
const g = require(path.join(__dirname, '..', '..', '..', 'skills', 'panlabs-aws-diagrams', 'validator', 'geometry.cjs'));
const c = require(path.join(__dirname, '..', '..', '..', 'skills', 'panlabs-aws-diagrams', 'validator', 'color.cjs'));
