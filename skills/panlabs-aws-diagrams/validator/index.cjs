...
const CHECAGENS = [
  ...
  {
    id: 'A1.1', family: 'A1', name: 'Título presente', severity: 'fail', input: 'modelo',
  ...
  {
    id: 'A1.2', family: 'A1', name: 'Legenda presente', severity: 'fail', input: 'geometria',
    mede: 'existe uma legenda no canvas',
    limiar: { descricao: 'presente' },
    fonte: 'C4 ("Every diagram should have a key/legend")',
  },
  {
    id: 'A1.3', family: 'A1', name: 'Legenda completa (cobertura de canal visual)', severity: 'fail', input: 'estilo',
  ...
  {
    id: 'A1.4', family: 'A1', name: 'Todo elemento nomeado', severity: 'fail', input: 'geometria',
    mede: '∀ nó, grupo: rótulo ≠ ""',
    limiar: { descricao: '100%' },
    fonte: 'C4 checklist; Azure WAF ("Label everything clearly"); Azure Icons',
  },
  {
    id: 'A1.5', family: 'A1', name: 'Todo elemento tipado', severity: 'fail', input: 'modelo',
    mede: '∀ nó, grupo: tipo ∈ catálogo',
    limiar: { descricao: '100%' },
    fonte: 'C4 ("The type of every element should be explicitly specified")',
  },
  {
    id: 'A1.6', family: 'A1', name: 'Toda aresta rotulada', severity: 'fail', input: 'geometria',
    mede: '∀ aresta: rótulo ≠ ""',
    limiar: { descricao: '100%' },
    fonte: 'C4 ("Every line should be labelled"); Azure WAF',
  },
  {
    id: 'A1.7', family: 'A1', name: 'Toda aresta unidirecional', severity: 'fail', input: 'estilo',
  ...
  {
    id: 'A1.8', family: 'A1', name: 'Nenhuma linha sem seta', severity: 'fail', input: 'estilo',
    mede: '∀ aresta: ao menos uma ponta de seta',
    limiar: { descricao: '100%' },
    fonte: 'Azure WAF ("Lines without arrows make relationships unclear")',
  },
  {
    id: 'A1.9', family: 'A1', name: 'Siglas expandidas', severity: 'warn', input: 'catalogo',
  ...
  {
    id: 'A1.10', family: 'A1', name: 'Um nível de abstração', severity: 'fail', input: 'modelo',
    mede: '|distinct(nível de abstração)| == 1',
    limiar: { descricao: '1' },
    fonte: 'C4 FAQ ("at the same level of abstraction"); Azure WAF ("Layer, don\'t overload")',
  },
  {
    id: 'A1.11', family: 'A1', name: 'Metadados de frescor', severity: 'warn', input: 'modelo',
  ...
  {
    id: 'A1.12', family: 'A1', name: 'Nenhum shape órfão', severity: 'fail', input: 'geometria',
  ...
  // ------------------------------------------------------------------- A2
  {
    id: 'A2.1', family: 'A2', name: 'Complexidade gráfica ≤ 6', severity: 'fail', escalona: true, input: 'estilo',
  ...
  {
    id: 'A2.2', family: 'A2', name: 'Ícone íntegro', severity: 'fail', input: 'estilo',
  ...
  {
    id: 'A2.3', family: 'A2', name: 'Cor de ícone não alterada', severity: 'fail', input: 'catalogo',
  ...
  {
    id: 'A2.4', family: 'A2', name: 'Ícone do catálogo oficial e atual', severity: 'warn', input: 'catalogo',
  ...
  {
    id: 'A2.5', family: 'A2', name: 'Tamanho de ícone uniforme por classe', severity: 'fail', input: 'geometria',
  ...
  {
    id: 'A2.6', family: 'A2', name: 'Codificação visual consistente por tipo', severity: 'fail', input: 'estilo',
  ...
  {
    id: 'A2.7', family: 'A2', name: 'Estilo de linha semanticamente consistente', severity: 'fail', input: 'estilo',
  ...
  {
    id: 'A2.8', family: 'A2', name: 'Borda de grupo segue a convenção containment vs. deployment', severity: 'warn', input: 'estilo',
  ...
  {
    id: 'A2.10', family: 'A2', name: 'Setas do conjunto predefinido', severity: 'warn', input: 'estilo',
  ...
  {
    id: 'A2.11', family: 'A2', name: 'Sem chartjunk', severity: 'fail', input: 'estilo',
  ...
  {
    id: 'A3.1', family: 'A3', name: 'Sobreposição nó–nó', severity: 'fail', input: 'geometria',
  ...
  {
    id: 'A3.2', family: 'A3', name: 'Sobreposição rótulo–rótulo', severity: 'fail', input: 'geometria',
  ...
  {
    id: 'A3.3', family: 'A3', name: 'Rótulo transbordando sua caixa', severity: 'fail', input: 'geometria',
  ...
  {
    id: 'A3.4', family: 'A3', name: 'Sobreposição rótulo–aresta', severity: 'fail', input: 'geometria',
  ...
  {
    id: 'A3.5', family: 'A3', name: 'Aresta atravessando nó', severity: 'fail', input: 'geometria',
  ...
  {
    id: 'A3.6', family: 'A3', name: 'Ancoragem de seta', severity: 'fail', input: 'geometria',
  ...
  {
    id: 'A3.7', family: 'A3', name: 'Nada fora do canvas', severity: 'fail', input: 'geometria',
  ...
  {
    id: 'A3.8', family: 'A3', name: 'Resolução de nó (NR)', severity: 'warn', input: 'geometria',
  ...
  {
    id: 'A3.9', family: 'A3', name: 'Tamanho mínimo de fonte', severity: 'warn', input: 'estilo', calibravel: true,
  ...
  {
    id: 'A4.1', family: 'A4', name: 'Contenção estrita', severity: 'fail', input: 'geometria',
  ...
  {
    id: 'A4.2', family: 'A4', name: 'Não-membro fora da região', severity: 'fail', input: 'geometria', semantica: true,
  ...
  {
    id: 'A4.3', family: 'A4', name: 'Grupos irmãos disjuntos', severity: 'fail', input: 'geometria',
  ...
  {
    id: 'A4.4', family: 'A4', name: 'Aninhamento geométrico == aninhamento lógico', severity: 'fail', input: 'geometria', semantica: true,
  ...
  {
    id: 'A4.5', family: 'A4', name: 'Padding de grupo uniforme', severity: 'warn', input: 'geometria',
  ...
  {
    id: 'A4.6', family: 'A4', name: 'Rótulo de grupo em posição canônica', severity: 'warn', input: 'geometria',
  ...
  {
    id: 'A4.7', family: 'A4', name: 'Razão de proximidade intra/inter grupo', severity: 'warn', input: 'geometria', calibravel: true,
  ...
  // ------------------------------------------------------------------- A5
  {
    id: 'A5.1', family: 'A5', name: 'Cruzamentos de aresta (EC)', severity: 'fail', escalona: true, input: 'geometria',
  ...
  {
    id: 'A5.2', family: 'A5', name: 'Ângulo de cruzamento (CA)', severity: 'fail', escalona: true, input: 'geometria',
  ...
  {
    id: 'A5.3', family: 'A5', name: 'Número de dobras por aresta', severity: 'fail', escalona: true, input: 'geometria', calibravel: true,
  ...
  {
    id: 'A5.4', family: 'A5', name: 'Ângulo de dobra', severity: 'fail', escalona: true, input: 'geometria', calibravel: false,
  ...
  {
    id: 'A5.5', family: 'A5', name: 'Aresta atravessando fronteira espúria', severity: 'fail', input: 'geometria', semantica: true,
  ...
  {
    id: 'A5.6', family: 'A5', name: 'Ortogonalidade de aresta (EO)', severity: 'warn', input: 'geometria',
  ...
  {
    id: 'A5.7', family: 'A5', name: 'Direção de fluxo consistente', severity: 'warn', input: 'geometria', calibravel: true,
  ...
  {
    id: 'A5.8', family: 'A5', name: 'Arestas paralelas separadas', severity: 'fail', input: 'geometria',
  ...
  {
    id: 'A5.9', family: 'A5', name: 'Uniformidade de comprimento de aresta (ELD)', severity: 'warn', input: 'geometria',
  ...
  // ------------------------------------------------------------------- A6
  {
    id: 'A6.1', family: 'A6', name: 'Resolução angular (AR)', severity: 'fail', escalona: true, input: 'geometria',
  ...
  {
    id: 'A6.2', family: 'A6', name: 'Uniformidade de nós (NU)', severity: 'warn', input: 'geometria',
  ...
  {
    id: 'A6.3', family: 'A6', name: 'Razão de aspecto (Asp)', severity: 'warn', input: 'geometria',
  ...
  {
    id: 'A6.4', family: 'A6', name: 'Alinhamento a grid', severity: 'warn', input: 'geometria', calibravel: true,
  ...
  {
    id: 'A6.5', family: 'A6', name: 'Preservação de vizinhança (NP) / Stress (KSM)', severity: 'warn', input: 'geometria',
  ...
  // ------------------------------------------------------------------- A7
  {
    id: 'A7.1', family: 'A7', name: 'Contraste de texto', severity: 'fail', input: 'estilo',
  ...
  {
    id: 'A7.2', family: 'A7', name: 'Contraste não-textual', severity: 'fail', input: 'estilo',
  ...
  {
    id: 'A7.3', family: 'A7', name: 'Cor não é o único canal', severity: 'fail', input: 'estilo',
  ...
  {
    id: 'A7.4', family: 'A7', name: 'Distinguibilidade sob deficiência de cor', severity: 'warn', input: 'estilo', calibravel: true,
  ...
  {
    id: 'A7.5', family: 'A7', name: 'Contraste da legenda', severity: 'fail', input: 'estilo',
  ...
  // ------------------------------------------------------------------- A8
  {
    id: 'A8.1', family: 'A8', name: 'Contagem de elementos de primeira classe', severity: 'fail', escalona: true, input: 'geometria',
  ...
  {
    id: 'A8.2', family: 'A8', name: 'Densidade de arestas', severity: 'warn', input: 'geometria',
  ...
  {
    id: 'A8.3', family: 'A8', name: 'Arestas por nó (fan-out)', severity: 'warn', input: 'geometria', calibravel: true,
    mede: 'max(grau(v))',
