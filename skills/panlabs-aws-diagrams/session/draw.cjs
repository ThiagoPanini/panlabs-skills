 ...
 * which is the real test of the thesis. Until #235 a check froze the bytes of
 * the PRODUCTION engine so that the next change to it was a deliberate one;
 * the bench that held it is gone.
 *
